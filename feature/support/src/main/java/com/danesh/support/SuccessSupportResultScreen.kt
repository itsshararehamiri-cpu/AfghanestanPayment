...
import com.danesh.support.presentation.SuccessSupportViewModel


@RequiresApi(Build.VERSION_CODES.O)
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SuccessSupportResultScreen(
    viewModel: SuccessSupportViewModel,
    response: String,
    onBackClick: () -> Unit,
    onHomeClick: () -> Unit,
    autoFinishDelayMs: Int = RESULT_AUTO_HOME_DELAY_MS,
    @StringRes successMessageRes: Int = R.string.support_transaction_was_successful,
    @StringRes transactionTitleRes: Int = R.string.support_title,
) {
