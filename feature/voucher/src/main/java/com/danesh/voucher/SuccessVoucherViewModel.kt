...
@HiltViewModel
class SuccessTopUpViewModel @Inject constructor(
    private val device: Device,
    private val queuePrintTracker: QueueCustomerReceiptPrintTracker,
) : ViewModel() {
    private val _uiState = MutableStateFlow(VoucherSuccessResultUiState())
    val uiState: StateFlow<VoucherSuccessResultUiState> = _uiState
...
data class VoucherSuccessResultUiState(
