...
@Composable
fun MicroPaymentIndexSettingsScreen(
    uiState: MicroPaymentIndexSettingsUiState,
    onBackClick: () -> Unit,
    ...
    Column(
        ...
        Toolbar(
            title = stringResource(R.string.settings_support_micro_payment_index_title),
        ...
        Column(
            ...
            SettingsSectionTitle(
                title = stringResource(R.string.settings_support_micro_payment_index_section),
            )

//            Text(
//                text = stringResource(R.string.settings_support_micro_payment_index_description),
...
@Composable
private fun MicroPaymentIndexSettingsScreenPreview() {
