...
fun SupportSettingsScreen(
    ...
    onDismissTmUpdateServerNotConfiguredMessage: () -> Unit = {},
...
//
//            SettingsNavigationRow(
//                label = stringResource(R.string.settings_support_default_id_title),
//                icon = R.drawable.ic_ip,
//                iconContentDescription = stringResource(R.string.settings_support_default_id_title),
//                onClick = onDefaultIdClick,
//            )

//            Spacer(modifier = Modifier.height(10.dp))
//
//            SettingsNavigationRow(
//                label = stringResource(R.string.settings_support_backup_platform),
//                icon = R.drawable.ic_connect_to_net,
//                iconContentDescription = stringResource(R.string.settings_support_backup_platform),
//                onClick = onBackupPlatformClick,
//            )
            ...
            if (uiState.showShowFee) {
                SettingsToggleRow(
                    label = stringResource(R.string.settings_support_show_fee_title),
                    icon = R.drawable.ic_shift,
                    iconContentDescription = stringResource(R.string.settings_support_show_fee_title),
...
//            SettingsNavigationRow(
//                label = stringResource(R.string.settings_support_terminal),
//                icon = R.drawable.ic_terminal_info,
//                iconContentDescription = stringResource(R.string.settings_support_terminal),
//                value = uiState.terminalInfo,
...
//            Spacer(modifier = Modifier.height(10.dp))
            ...
            if (uiState.showSupportServices) {
                SettingsNavigationRow(
                    label = stringResource(R.string.settings_support_services),
                    icon = R.drawable.ic_card_tick,
                    iconContentDescription = stringResource(R.string.settings_support_services),
                    onClick = {
                    //    showSupportServicesDialog = true
            ...
            if (uiState.showVatPercentage) {
                SettingsNavigationRow(
                    label = stringResource(R.string.settings_support_vat_percentage),
                    icon = R.drawable.ic_shift,
                    iconContentDescription = stringResource(R.string.settings_support_vat_percentage),
                    value = stringResource(
                        R.string.settings_support_vat_percentage_value,
                        uiState.vatPercentage,
                    ),
                    valueColor = SettingsColors.TextPrimary,
                    onClick = onVatPercentageClick,
                )
            ...
            if (uiState.showMicroPaymentIndex) {
                SettingsNavigationRow(
                    label = stringResource(R.string.settings_support_micro_payment_index),
                    icon = R.drawable.ic_card_tick,
                    iconContentDescription = stringResource(R.string.settings_support_micro_payment_index),
                    value = stringResource(
                        R.string.settings_support_micro_payment_index_value,
                        uiState.microPaymentIndexAmount,
                    ),
                    valueColor = SettingsColors.TextPrimary,
                    onClick = onMicroPaymentIndexClick,
                )
            ...
            if (uiState.showTmsSection) {
                ...
                SettingsNavigationRow(
                    label = stringResource(R.string.settings_merchant_tm_update),
                    icon = R.drawable.ic_configuration,
                    iconContentDescription = stringResource(R.string.settings_merchant_tm_update),
                    onClick = { showTmUpdateDialog = true },
                )
    ...
    /*if (showSupportServicesDialog) {
        AlertDialog(
            onDismissRequest = { showSupportServicesDialog = false },
            title = {
                Text(
                    text = stringResource(R.string.settings_support_services),
                    style = MaterialTheme.typography.titleMedium,
                )
            },
            text = {
                Text(
                    text = stringResource(R.string.settings_support_services_message),
                    style = MaterialTheme.typography.bodyMedium,
                )
            },
            confirmButton = {
                TextButton(
                    onClick = {
                        showSupportServicesDialog = false
                        onSupportServicesClick()
                    },
                ) {
                    Text(
            ...
            dismissButton = {
                TextButton(onClick = { showSupportServicesDialog = false }) {
                    Text(
                        text = stringResource(R.string.settings_cancel),
                        style = MaterialTheme.typography.bodySmall,
                    )
    ...
    if (showTmUpdateDialog) {
//        AlertDialog(
//            onDismissRequest = { showTmUpdateDialog = false },
//            title = {
//                Text(
//                    text = stringResource(R.string.settings_merchant_tm_update),
//                    style = MaterialTheme.typography.titleMedium,
//                )
//            },
//            text = {
//                Text(
//                    text = stringResource(R.string.settings_support_tm_update_message),
//                    style = MaterialTheme.typography.bodyMedium,
//                )
//            },
//            confirmButton = {
...
//            },
//            dismissButton = {
//                TextButton(onClick = { showTmUpdateDialog = false }) {
//                    Text(
//                        text = stringResource(R.string.settings_cancel),
//                        style = MaterialTheme.typography.bodySmall,
//                    )
...
//        )
    ...
    uiState.tmUpdateServerNotConfiguredMessage?.let { message ->
        AlertDialog(
            onDismissRequest = onDismissTmUpdateServerNotConfiguredMessage,
            text = {
                Text(
                    text = message,
                    style = MaterialTheme.typography.bodyMedium,
            ...
            confirmButton = {
                TextButton(onClick = onDismissTmUpdateServerNotConfiguredMessage) {
                    Text(
                        text = stringResource(R.string.settings_support_confirm),
                        style = MaterialTheme.typography.bodySmall,
                    )
...
@Composable
private fun SupportSettingsScreenPreview() {
