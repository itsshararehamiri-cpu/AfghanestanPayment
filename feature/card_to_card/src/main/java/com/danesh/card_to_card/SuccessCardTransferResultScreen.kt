...
import com.danesh.card_to_card.presentation.viewmodel.SuccessCardTransferViewModel
...
@Composable
fun SuccessCardTransferResultScreen(
    viewModel: SuccessCardTransferViewModel,
    response: String,
    onBackClick: () -> Unit,
    onHomeClick: () -> Unit,
    ...
    TransactionResultScreen(
        ...
        messageTransaction = stringResource(R.string.card_to_card_was_successful),// TODO:
        isSuccess = true,
...
@Composable
private fun CardTransferReceipt(
