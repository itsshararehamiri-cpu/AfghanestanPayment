...
import com.danesh.purchase.domain.PurchaseUseCase
import com.danesh.purchase.navigation.PurchaseNavArgs
...
class GetPinViewModel @Inject constructor(
    ...
    private val amount: String =
        savedStateHandle.get<String>(PurchaseNavArgs.AMOUNT).orEmpty()
