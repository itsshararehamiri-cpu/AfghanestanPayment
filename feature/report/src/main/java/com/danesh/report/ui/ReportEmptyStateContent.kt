...
fun ReportEmptyStateContent(
    ...
    @DrawableRes illustrationRes: Int = R.drawable.ic_report_empty,
) {
    Column(
...
fun ReportEmptyStateActions(
    ...
    Column(
        ...
        GradientActionButton(
            ...
            text = stringResource(com.danesh.common.R.string.action_retry),
...
fun ReportEmptyStateScreen(
    ...
    Column(
        ...
        Toolbar(title = title, onBackClick = onCancelClick)
