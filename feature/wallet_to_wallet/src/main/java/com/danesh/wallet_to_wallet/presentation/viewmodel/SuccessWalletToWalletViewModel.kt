...
@HiltViewModel
class SuccessWalletToWalletViewModel @Inject constructor(
    private val device: Device,
    private val queuePrintTracker: QueueCustomerReceiptPrintTracker,
) : ViewModel() {
    private val _uiState = MutableStateFlow(SuccessWalletToWalletUiState())
    val uiState: StateFlow<SuccessWalletToWalletUiState> = _uiState
...
data class SuccessWalletToWalletUiState(
