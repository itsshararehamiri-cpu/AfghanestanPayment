...
@HiltViewModel
class UnSuccessWalletToWalletViewModel @Inject constructor(
    private val device: Device,
) : ViewModel() {
    private val _uiState = MutableStateFlow(UnSuccessWalletToWalletUiState())
    val uiState: StateFlow<UnSuccessWalletToWalletUiState> = _uiState
...
data class UnSuccessWalletToWalletUiState(
