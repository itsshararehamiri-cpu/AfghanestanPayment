...
/**
 * ISO8583 packager سداد — ISO 93B binary bitmap، طبق سند «Terminal Message Protocol» سداد (شبکهٔ شتاب).
 *
 * تعریف فیلدها مطابق سند: F22=POS Entry Mode (n3)، F24=NII ثابت "007"، F35=LLCHAR 37 (Track2)،
 * F41=Terminal Id (ans8)، F42=Acceptor Id (ans15، طول ثابت)، F48/F59/F60-63=LLLCHAR 999 (خام،
 * بدون قالب TLV — هر تراکنش قالب ثابت خودش را دارد)، F52/F64=BINARY 8 (PIN/MAC).
 */
public class SadadIso93BPackager extends ISOBasePackager {
    ...
    protected ISOFieldPackager fld[] = {
            ...
            /*022*/ new IFB_NUMERIC(12, "Point of service data code", pad),
            /*023*/ new IFB_NUMERIC(3, "Card sequence number", pad),
            /*024*/ new IFB_NUMERIC(3, "Network International Identifier (NII)", pad),
            /*025*/ new IFB_NUMERIC(4, "POS Condition code", pad),
            ...
            /*037*/ new IFB_NUMERIC(12, "Retrieval reference number", pad),
            /*038*/ new IFB_NUMERIC(6, "Approval code", pad),
            /*039*/ new IFB_NUMERIC(3, "Action code", true),
            /*040*/ new IFB_NUMERIC(3, "Service code", pad),
            /*041*/ new IFB_NUMERIC(8, "Card acceptor terminal identification", pad),
            ...
            /*051*/ new IFB_NUMERIC(3, "Currency code, Cardholder billing", pad),
            ...
            /*060*/ new IFB_LLLCHAR(999, "Private1"),
            /*061*/ new IFB_LLLCHAR(999, "Private2"),
            /*062*/ new IFB_LLLCHAR(999, "Private3"),
            /*063*/ new IFB_LLLCHAR(999, "Private4"),
