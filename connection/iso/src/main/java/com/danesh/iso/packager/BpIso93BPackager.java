...
/**
 * ISO8583 packager به‌پرداخت (BP) — ISO 87B binary bitmap (مطابق ISO87BPackagerQuartz).
 *
 ...
 */
public class BpIso93BPackager extends ISO87BPackager {
    ...
    protected ISOFieldPackager fld[] = {
            ...
            /*028*/ new IFB_AMOUNT  (1+7, "Amount, transaction fee", pad),
            /*029*/ new IFB_AMOUNT  (1+7, "Amount, settlement fee", pad),
            /*030*/ new IFB_AMOUNT  (1+7, "Amount, transaction processing fee", pad),
            /*031*/ new IFB_AMOUNT  (1+7, "Amount, settlement processing fee", pad),
            ...
            /*046*/ new IFB_LLLCHAR (999, "Additional data (ISO)"),
            ...
            /*053*/ new IFB_NUMERIC (  8, "Security related control information",pad),
            /*054*/ new IFB_LLLCHAR (120, "Amounts, additional"),
            /*055*/ new IFB_LLLCHAR (999, "Host receipt text line 1 (ANS)"),
            /*056*/ new IFB_LLLCHAR (999, "Host receipt text line 2 (ANS)"),
            ...
            /*062*/ new IFB_LLLCHAR(999, "Reserved for private use"),//IFB_LLLBINARY
