...
public class ByteUtil {
    ...
    public static synchronized String byte2Hex(byte[] buffer) {
        String h = "";
    ...
    public static synchronized byte[] hex2Byte(String s) {
        int len = s.length();
    ...
    public static synchronized String hex2Str(String hex){
